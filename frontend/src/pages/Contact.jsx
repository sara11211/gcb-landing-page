                    ...
                    <form
                        ...
                        onSubmit={async (e) => {
                            ...
                            if (!name || !email || !subject || !message) {
                                setStatus({ ok: false, text: "Veuillez remplir tous les champs requis." });
                                return;
                            }
                            ...
                            try {
                                ...
                                if (res.ok && data.success) {
                                    ...
                                    // clear form
                                    setName(""); setEmail(""); setSubject(""); setRecipient(""); setMessage("");
                                } else {
                                    setStatus({ ok: false, text: data.error || "Erreur lors de l'envoi." });
                                }
                            } catch (err) {
                                console.error(err);
                    ...
                    >
                        ...
                        <div className="text-center">
                            <button
                                type="submit"
                                disabled={loading}
                                className="bg-primary-orange hover:bg-orange-600 text-white px-8 py-3 rounded-full font-medium transition-all flex items-center gap-2 mx-auto cursor-pointer disabled:opacity-50"
                            >
